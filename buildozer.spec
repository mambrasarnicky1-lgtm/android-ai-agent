[app]
title = Noir Sovereign Elite v18.1
package.name = noir_sovereign
package.domain = org.noir.sovereign
source.dir = mobile_app
source.include_exts = py,png,jpg,kv,atlas
version = 18.1.0
requirements = python3,kivy,requests,pillow,pyjnius,cython,pycryptodome,urllib3,certifi,idna,chardet,adb-shell,setuptools
